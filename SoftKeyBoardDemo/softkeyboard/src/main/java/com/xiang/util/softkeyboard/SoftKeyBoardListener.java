package com.xiang.util.softkeyboard;
...
public class SoftKeyBoardListener {
    ...
    public interface OnSoftKeyBoardChangeListener {
        void keyBoardShow(int height);// 显示键盘

        void keyBoardHide(int height);// 关闭键盘
    }
   ...
   private static  SoftKeyBoardListener softKeyBoardListener;
    ...
    public  static  void KeyBoardCancle(Activity context) {
        ...
        if (view != null) {
            InputMethodManager inputmanger = (InputMethodManager)context. getSystemService(INPUT_METHOD_SERVICE);
